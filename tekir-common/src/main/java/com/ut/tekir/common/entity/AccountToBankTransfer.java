...
/**
 * Account to Bank Transfer document.
 */
@Entity
@Table(name = "ACCOUNT_TO_BANK_TRANSFER")
@Getter
@Setter
public class AccountToBankTransfer extends DocumentBase {
    ...
    @Override
    public DocumentType getDocumentType() { return DocumentType.AccountToBankTransfer; }
}
