...
@Entity @Table(name = "TEKIR_ORDER_NOTE_CURRENCY_RATE") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class TekirOrderNoteCurrencyRate extends AuditBase {
