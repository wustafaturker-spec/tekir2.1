...
@Entity @Table(name = "TEKIR_ORDER_NOTE_TAX_SUMMARY") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class TekirOrderNoteTaxSummary extends AuditBase {
