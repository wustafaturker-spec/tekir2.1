...
@Entity @Table(name = "TEKIR_SHIPMENT_NOTE_CURRENCY_RATE") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class TekirShipmentNoteCurrencyRate extends AuditBase {
