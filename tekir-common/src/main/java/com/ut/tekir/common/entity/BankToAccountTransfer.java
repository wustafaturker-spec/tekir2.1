...
/**
 * Bank to Account Transfer document.
 */
@Entity
@Table(name = "BANK_TO_ACCOUNT_TRANSFER")
@Getter
@Setter
public class BankToAccountTransfer extends DocumentBase {
    ...
    @Override
    public DocumentType getDocumentType() { return DocumentType.BankToAccountTransfer; }
}
