...
@Entity @Table(name = "TEKIR_INVOICE_TAX_SUMMARY") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class TekirInvoiceTaxSummary extends AuditBase {
