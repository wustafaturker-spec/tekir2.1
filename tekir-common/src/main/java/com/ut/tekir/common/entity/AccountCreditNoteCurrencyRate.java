...
@Entity @Table(name = "ACCOUNT_CREDIT_NOTE_CURRENCY_RATE") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class AccountCreditNoteCurrencyRate extends AuditBase {
    private static final long serialVersionUID = 1L;
    @Id @GeneratedValue(strategy = GenerationType.TABLE, generator = "genericSeq") @Column(name = "ID") private Long id;
    @ManyToOne @JoinColumn(name = "OWNER_ID") private AccountCreditNote owner;
