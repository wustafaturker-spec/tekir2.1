...
@Entity @Table(name = "TEKIR_SHIPMENT_NOTE_DETAIL") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class TekirShipmentNoteDetail extends AuditBase {
