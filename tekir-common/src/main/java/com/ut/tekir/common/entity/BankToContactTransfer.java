...
/**
 * Bank to Contact Transfer document.
 */
@Entity
@Table(name = "BANK_TO_CONTACT_TRANSFER")
@Getter
@Setter
public class BankToContactTransfer extends DocumentBase {
    ...
    @Override
    public DocumentType getDocumentType() { return DocumentType.BankToContactTransfer; }
}
