...
@Entity @Table(name = "ACCOUNT_CREDIT_NOTE_DETAIL") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class AccountCreditNoteDetail extends AuditBase {
