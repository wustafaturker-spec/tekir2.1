...
@Getter
@Setter
public class PromissoryNote extends DocumentBase {
    ...
    // Using ChequeStatus for now as placeholder, likely needs its own or generic status
    @Enumerated(EnumType.ORDINAL)
    @Column(name = "STATUS")
    private ChequeStatus status = ChequeStatus.Portfoy;
    
    @Column(name = "PROMISSORY_OWNER")
    private String promissoryOwner;
    ...
    public DocumentType getDocumentType() {
        return DocumentType.PromissoryStatusChanging;
    }
}
