...
@Entity @Table(name = "TEKIR_SHIPMENT_NOTE_CURRENCY_SUMMARY") @Getter @Setter @EqualsAndHashCode(of = "id", callSuper = false)
public class TekirShipmentNoteCurrencySummary extends AuditBase {
